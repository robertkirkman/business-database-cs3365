...
public class EmployeeTable {
	// Pre-chosen table fields using dynamically allocated arrays
		...
		//Query method
		public String QueryEmployeeField(String FieldName, String QueryString)
		{
		...
		public String ModifyEmployeeField(String FieldName, String QueryString, String EntryString)
		{
			switch(FieldName)
			{
				case "Name":
